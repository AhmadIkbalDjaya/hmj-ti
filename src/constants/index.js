...
import produk1 from "../assets/produk/galdan1.webp";
import produk2 from "../assets/produk/galdan2.webp";
...
export const articles = [
    ...
    // },
    {
        ...
        description:
            "Program Studi (Prodi) Teknik Informatika (TI) Fakultas Sains dan Teknologi (FST) UIN Alauddin Makassar menyelenggarakan perayaan 2 dekade Teknik Informatika di Pantai Akkarena, Kota Makassar, Senin (4/11/2024)",
        image: dekadePic,
...
“Tema kali ini diambil karena kita melirik kembali perjalan 20 tahun TI yang telah mengalami berbagai inovasi diantaranya berbagai prestasi yang diraih oleh sejumlah mahasiswa di tingkat nasional,” tuturnya.
    ...
    },
    {
        ...
        description:
            "Himpunan Mahasiswa Jurusan (HMJ) Teknik Informatika (TI) Fakultas Sains dan Teknologi (FST) UIN Alauddin Makassar selenggarakan Kelas Advokasi Vol 4 dengan tema “Menyapa Lingkar Ormawa, sebagai Upaya untuk Menapaki Jalan Setapak Fungsionaris Meng-Internal-lisasi Kelembagaan” di pelataran Gedung D FST, Sabtu (23/11/2024)",
        image: advokasiPic,
...
export const products = [
    {
        id: 1,
        name: "Rice Bowl Sambal Ikan Suwir",
        description:
            "Nasi hangat dengan ikan suwir pedas bercita rasa autentik, dipadu sambal khas yang menggugah selera. Lezat, praktis, dan cocok untuk makan siang Anda!",
        image: produk2,
        contact: "085141327965",
    ...
    },
    {
        ...
        description:
            "Gurih, pedas, dan nikmat! Pangsit premium dengan saus chili oil khas yang menggugah selera. Cocok untuk camilan atau pelengkap hidangan Anda!",
        image: produk1,
        contact: "085141327965",
